...
const DemoUseParam = () => {
  ...
  return (
    <div className="container">
      DemoUseParam paramID: {params.id}
        ...
        <div className="row">
          ...
          <div className="col-5">
            ...
            <div className="d-flex gap-2 mb-3">
              <img
                src="https://dummyimage.com/50/f00e38/0011ff"
                className="img-thumbnail border-2 border-dark"
                alt="color1"
              />
              <img
                src="https://dummyimage.com/50/09eb8d/0011ff"
                className="img-thumbnail"
                alt="color2"
              />
              <img
                src="https://dummyimage.com/50/09eeee/e4f222"
                className="img-thumbnail"
                alt="color3"
              />
            </div>
            ...
            <button className="btn btn-outline-secondary w-100 mb-3">
              Favourite <span className="ms-1">&#9825;</span>
            </button>
            {/* Description */}
            <div className="mb-2 small">
              Comfortable, durable and timeless—it's number one for a reason.
              This AF-1 pairs crisp leather with mini metal accents to create a
              clean, classic look.
            </div>
            <ul className="small">
            ...
            <div
              className="small text-decoration-underline mb-3"
              style={{ cursor: "pointer" }}
            >
