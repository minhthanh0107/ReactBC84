...
const ProductsPage = (props) => {
  ...
  const getProductApiAxios = async () => {
    try {
      ...
      // Sau khi lấy dữ liệu từ api về thì setStates
  ...
  useEffect(() => {
    ...
    getProductApiAxios();
  }, []); // state dependencies: thì state nào liệt kê trong mảng thay đổi thì hàm này mới gọi lại. Nếu là mảng rỗng (ko phụ thuộc vào state nào) nên chỉ gọi 1 lần
